...
<Callout type="info">
**Status (2026-05-23).** Shipped on `main`. Open palm + pinch calibration, SPACE dead-man, per-side tracking-loss handling, WS disconnect grace, mutual exclusion, and end-to-end smoke tests are all working.
</Callout>
...
4. **Frame yourself** so both shoulders and both hands are visible. The HUD shows live tracking per side; the skeleton overlay draws on the feed.
