...
| `observation.images.overshoulder_sim` | operator view, from the mount side (the default teleop view) |
| `observation.images.threequarter_sim` | operator view, face-to-face |
| `observation.images.overhead_sim` | plan view |
| `observation.images.wrist_left_sim` / `wrist_right_sim` | per-arm gripper close-ups, riding the wrist |
