---
title: LeRobot environment
description: Conda env for Haller's SO-101 arms — Python 3.12, PyTorch + CUDA, Feetech SDK, isolated from ROS and user-site site-packages.
---
...
Once the env is verified, move on to [Configure & calibrate the SO-101 arm](/docs/setup/so101-arm) to configure the motors and calibrate the arm.
...
For cross-cutting issues (calibration, HMI runtime, networking) see [Troubleshooting](/docs/troubleshooting).
