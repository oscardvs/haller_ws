...
| Inline fuse holders + ATO fuses (15 A main, 10 A arm-buck input, 10 A **fast-blow** arm rail, 2× 6 A per arm, 5 A Jetson) | 1 set | ❌ €12 | The arm-rail fuse must be fast-blow — it is half of the crowbar. |
...
| Item | Qty | Status | Notes |
|---|---|---|---|
| Sealed automotive buck, **15–40 V in**, 12 V **≥10 A**, synchronous | 1 | ❌ €18 | Verify the *input range*, not the "24V" in the product title — many specify an 18–20 V minimum, which sits at the pack's operating floor. |
...
| Sealed buck 15–40 V → 12 V, ≥10 A | 18 | **Yes** |
